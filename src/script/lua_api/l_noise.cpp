...
void PerlinNoiseMap_get2dMap_flat(void **pnmp, double px, double py, float *buffer)
{
	NO_MAP_LOCK_REQUIRED;
...
void PerlinNoiseMap_get3dMap_flat(void **pnmp, double px, double py, double pz, float *buffer)
{
	NO_MAP_LOCK_REQUIRED;
...
void PerlinNoiseMap_getMapSlice(void **pnmp, u16 px, u16 py, u16 pz, u16 sx, u16 sy, u16 sz, float *buffer)
{
	NO_MAP_LOCK_REQUIRED;
